...
class GeoLocation:
    ...
    def get_nearby_restaurants(self, latitude, longitude, radius=3000):
        ...
        try:
            ...
            print(
                f"Key error: {e}. The API response format might have changed or the provided place_id could be invalid.",
                flush=True,
            )
    ...
    def get_restaurant_details(self, place_id):
        ...
        try:
            ...
            details["open_now"] = result.get("current_opening_hours", {}).get(
                "open_now", ""
            )
