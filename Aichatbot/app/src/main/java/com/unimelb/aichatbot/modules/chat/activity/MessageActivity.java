package com.unimelb.aichatbot.modules.chat.activity;
...
import com.unimelb.aichatbot.modules.chat.adapter.MessageAdapter;
import com.unimelb.aichatbot.modules.chat.MessageViewModel;
...
import com.unimelb.aichatbot.network.RetrofitClient;
...
// Check if the app has internet permission
        ...
        ChatService chatService = RetrofitFactory.create(ChatService.class);
//       send request to get all messages
        Call<List<Message>> call = chatService.getAllMessages();
    ...
    private void handleSendMessage() {
        ...
        if (!messageContent.isEmpty()) {
            ...
            ChatService chatService = RetrofitClient.getService();
